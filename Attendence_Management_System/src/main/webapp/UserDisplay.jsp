        ...
        <tr class="attendanceRow" data-department="${A.dname}">
            ...
            <td>
                <select class="attendanceStatus">
                    <option value="Present" <c:if test="${A.attendence eq 'Present'}">selected</c:if>>Present</option>
                    <option value="Absent" <c:if test="${A.attendence eq 'Absent'}">selected</c:if>>Absent</option>
                </select>
            </td>
            <td>${A.doc}</td>
        </tr>
